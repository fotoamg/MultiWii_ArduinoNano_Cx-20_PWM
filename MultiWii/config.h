...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define MONGOOSE1_0     // mongoose 1.0    http://store.ckdevices.com/v
    ...
    /***************************    independent sensors    ********************************/
      ...
      /* I2C barometer */
      //#define BMP085 /*GAMMA - uncomment this back!*/
      //#define MS561101BA
...
//#define EXTENDED_AUX_STATES
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      ...
      //#define SERIAL_SUM_PPM         THROTTLE,YAW,PITCH,ROLL,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For Graupner/Spektrum
     // #define SERIAL_SUM_PPM           THROTTLE,YAW,ROLL,PITCH,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //Miki
      #define SERIAL_SUM_PPM           0,1,3,2,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //Miki2
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_THROTTLE  (MINTHROTTLE + 250)    // (*) Throttle level used for landing - may be relative to MINTHROTTLE - as in this case
